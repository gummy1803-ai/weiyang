...
import { coreSpec } from './core.js?v=20260906v9';
import { planet1Spec } from './planet1.js?v=20260906v9'; // GARGANTUA 黑洞
import { betelgeuseSpec } from './planet_betelgeuse.js?v=20260906v9'; // 参宿四
import { saturnSpec } from './planet_saturn.js?v=20260906v9'; // 土星
import { crabSpec } from './planet_crab.js?v=20260906v9'; // 蟹状星云
import { rosetteSpec } from './planet_rosette.js?v=20260906v9'; // 玫瑰星云
import { carinaSpec } from './planet_carina.js?v=20260906v9'; // 船底座星云
import { velaSpec } from './planet_vela.js?v=20260906v9'; // 船帆座星云
import { tarantulaSpec } from './planet_tarantula.js?v=20260906v9'; // 蜘蛛星云
